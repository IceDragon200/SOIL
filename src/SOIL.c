...
unsigned int SOIL_direct_load_DDS(const char *filename, unsigned int reuse_texture_ID, int flags, int loading_as_cubemap);
unsigned int SOIL_direct_load_DDS_from_memory(const unsigned char *const buffer, int buffer_length, unsigned int reuse_texture_ID, int flags, int loading_as_cubemap);
/*	other functions	*/
unsigned int SOIL_internal_create_OGL_texture(const unsigned char *const data, int width, int height, int channels, unsigned int reuse_texture_ID, unsigned int flags, unsigned int opengl_texture_type, unsigned int opengl_texture_target, unsigned int texture_check_size_enum);

/*	and the code magic begins here [8^)	*/
unsigned int
SOIL_load_OGL_texture(const char *filename, int force_channels,
...
//unsigned int
//SOIL_load_OGL_HDR_texture(const char *filename, int fake_HDR_format,
//                          int rescale_to_max, unsigned int reuse_texture_ID, unsigned int flags)
//{
//  /*	variables	*/
//  unsigned char* img;
//  int width, height, channels;
...
//  /* error check */
//  if ((fake_HDR_format != SOIL_HDR_RGBE) && (fake_HDR_format != SOIL_HDR_RGBdivA) && (fake_HDR_format != SOIL_HDR_RGBdivA2)) {
...
unsigned int
SOIL_load_OGL_texture_from_memory(const unsigned char *const buffer, int buffer_length,
...
unsigned int
SOIL_load_OGL_cubemap(const char *x_pos_file, const char *x_neg_file,
...
unsigned int
SOIL_load_OGL_single_cubemap(const char *filename, const char face_order[6],
                             int force_channels, unsigned int reuse_texture_ID, unsigned int flags
                            )
{
  /*	variables	*/
...
unsigned int
SOIL_create_OGL_single_cubemap(const unsigned char *const data,
...
int
SOIL_save_screenshot(const char *filename, int image_type, int x, int y,
...
unsigned char*
SOIL_load_image(const char *filename, int *width, int *height, int *channels, int force_channels)
{
...
unsigned char*
SOIL_load_image_from_memory(const unsigned char *const buffer, int buffer_length,
                            int *width, int *height, int *channels, int force_channels)
{
...
int
SOIL_save_image(const char *filename, int image_type, int width, int height,
...
unsigned int SOIL_direct_load_DDS(const char *filename, unsigned int reuse_texture_ID,
                                  int flags, int loading_as_cubemap)
{
  FILE *f;
